...
const Student = () => {
    ...
    const handleStudentRegister = async (e) => {
        e.preventDefault();
        const isValidDomain = email.endsWith('@iiita.ac.in');
        if (!isValidDomain) {
            toast.error("Invalid email, please enter IIITA email Id")
            return;
        }
    ...
    const options = [
        ...
        { value: 'VH-1', label: 'VH-1' },
        { value: 'VH-2', label: 'VH-2' },
        { value: 'VH-3', label: 'VH-3' },
        { value: 'PHD-Scolar-Appartment', label: 'PHD-Scholar-Appartment' },
      ];
    ...
    return(
        <div className="person">
            ...
            <div className="auth">
                <h1>Welcome</h1>
                <h2>Please login using your college credentials</h2>
            </div>
                        ...
                        <div className="auth-container-2">
                            ...
                            <div className="auth-box">
                                <form className="auth-2" onSubmit={handleStudentRegister}>
                                    ...
                                    <input type="text" placeholder="Enrollment Number" className="auth-inp uc" onChange={(e) => {setEnrollment(e.target.value.toUpperCase())}} required/>
                                    <input type="email" placeholder="Email Address (@iiita.ac.in)" className="auth-inp" onChange={(e) => {setEmail(e.target.value)}} required/>
                                    <input type="password" placeholder="Password" className="auth-inp" onChange={(e) => {setPassword(e.target.value)}} required/>

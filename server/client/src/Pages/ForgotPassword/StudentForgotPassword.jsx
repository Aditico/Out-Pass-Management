        ...
        <div className="fp-box">
            {
                isOtpSub ? (
                    ...
                    <form className="fp-form" onSubmit={handleSubmit}>
                        ...
                        <input type="text" name="enroll" id='enroll' className="fp-inp fp-up" placeholder='eg. IIB2023029' onChange={(e) => {setEnrollment(e.target.value.toUpperCase())}} required/>
                        <label htmlFor="email" className="fp-label">Enter your Email Id:</label>
                        <input type="email" name='email' id='email' className="fp-inp" placeholder='eg. iib2023029@iiita.ac.in' onChange={(e) => {setEmail(e.target.value)}} required/>
                        {isDetailSub &&
                            <>
